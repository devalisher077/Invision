...
Веб-приложение для цифровой приемной кампании университета. Проект объединяет личный кабинет абитуриента, загрузку документов, внутреннее тестирование, отдельный интерфейс для приемной комиссии и локальный AI-backend для анализа видеопрезентаций и эссе.
